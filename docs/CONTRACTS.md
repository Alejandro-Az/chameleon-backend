...
- `APPOINTMENT_SLOT_UNAVAILABLE` (422) — horario no disponible para el servicio/staff solicitado
- `APPOINTMENT_CANCELLATION_WINDOW_CLOSED` (403) — la ventana de cancelacion ya se cerro
- `APPOINTMENT_RESCHEDULE_WINDOW_CLOSED` (403) — la ventana de reagenda ya se cerro
- `APPOINTMENT_STATUS_TRANSITION_INVALID` (422) — transicion de estado no valida para la cita
